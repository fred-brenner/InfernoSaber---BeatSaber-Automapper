...
def create_map(y_class_num, timings, events, name, bpm, pitch_input, pitch_times):
    ...
    def write_map(notes, timings, events, name, bpm, bs_diff,
        ...
        # timings = improve_timings(notes, timings, pitch_input, pitch_times)   # TODO: check if reactivation useful
...
#   "_songName": "#ThatPOWER",
#   "_songSubName": "",
#   "_songAuthorName": "Will.i.am",
#   "_levelAuthorName": "TheLonewolvez",
#   "_beatsPerMinute": 128,
#   "_songTimeOffset": 0,
#   "_shuffle": 0,
#   "_shufflePeriod": 0.5,
