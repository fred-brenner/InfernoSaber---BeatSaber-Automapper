...
# Data Preprocessing
####################
ml_input, ml_output, ml_arrow = load_ml_data()
ml_input_arrow = copy.deepcopy(ml_input)
...
ml_input, ml_output = lstm_shift_events_half(in_song_l, ml_time_in, ml_output, config.lstm_len)
[in_song_l, in_time_l, in_class_l] = ml_input
